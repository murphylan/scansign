  ...
  return (
    <div className="bg-white/95 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-primary/20">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground mt-2">加入 Murphy 互动工具集</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <button
          type="submit"
          disabled={isPending}
          className="w-full py-3 px-4 rounded-lg bg-gradient-to-r from-primary to-amber-500 hover:from-primary/90 hover:to-amber-500/90 text-white font-medium flex items-center justify-center gap-2 transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isPending ? (
